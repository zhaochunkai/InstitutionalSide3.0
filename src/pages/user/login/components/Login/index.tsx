...
interface LoginType extends React.FC<LoginProps> {
  ...
  TenancyName: React.FunctionComponent<LoginItemProps>;
  VertifyPic: React.FunctionComponent<LoginItemProps>;
  ...
  Captcha1: React.FunctionComponent<LoginItemProps>;
}
...
Login.TenancyName = LoginItem.TenancyName;
Login.VertifyPic = LoginItem.VertifyPic;
Login.UserName = LoginItem.UserName;
Login.Password = LoginItem.Password;
Login.Mobile = LoginItem.Mobile;
Login.Captcha = LoginItem.Captcha;
Login.Captcha1 = LoginItem.Captcha1;
